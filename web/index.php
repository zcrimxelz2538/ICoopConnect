				...
				case "ข้อมูลสมาชิก"	 :
					$response = $bot->getProfile($event->getUserId());
		                    if ($response->isSucceeded()) {
														...
														$button = new \LINE\LINEBot\MessageBuilder\TemplateBuilder\ButtonTemplateBuilder("ข้อมูลสมาชิก", "เลขสมาชิก : 00008073 (สมาชิกปกติ) เลขบัตรประชาชน : 3-5805-00056-66-8 วันเกิด : 20 พ.ย. 2520 (39 ปี 10 เดือน)", $img_url, $actions);
